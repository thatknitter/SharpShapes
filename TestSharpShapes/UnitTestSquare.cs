...
namespace TestSharpShapes
{
    ...
    public class UnitTestSquare
    {
        ...
        {
            Square square = new Square(0, 20);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void TestSquareHeightSanityCheck()
        {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void TestSquareConstructorHeightPositiveSanityCheck()
        {
            Square square = new Square(20, -1);
        }
