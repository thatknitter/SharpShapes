...
namespace TestSharpShapes
{
    ...
    public class UnitTestRectangles
    {
        ...
        {
            Rectangle rectangle = new Rectangle(40, 50, 90);
        ...
        {
            Rectangle rectangle = new Rectangle(0, 50, 90);   
        }
        ...
        {
            Rectangle rectangle = new Rectangle(-1, 50, 90);
        }
        ...
        {
            Rectangle rectangle = new Rectangle(50, 0, 90);
        }
        ...
        {
            Rectangle rectangle = new Rectangle(50, -1, 90);
        }
        ...
        {
            Rectangle rectangle = new Rectangle(10, 15, 90);
            rectangle.Scale(200);
        ...
        {
            Rectangle rectangle = new Rectangle(1, 5, 90);
        ...
        {
            Rectangle rectangle = new Rectangle(10, 100, 90);
        ...
        {
            Rectangle shape = new Rectangle(10, 15, 90);
